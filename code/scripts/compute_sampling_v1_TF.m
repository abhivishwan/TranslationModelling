function [mean_error, var_error, p_true, logP, nofeedback_mean, nofeedback_var, feedback_mean, feedback_var, p_nofeedback, p_feedback] = compute_sampling_v1_TF( X, target, headAngle_t, feedback, headAngle_feedback )
