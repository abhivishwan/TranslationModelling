function nLL = lik_pureLandmark_v1_TF(X, target, headAngle_t, feedback, headAngle_feedback)
...
[feedback_mean, feedback_var] = compute_pureLandmark_v1_TF( X(1:8), target, feedback, headAngle_feedback );
